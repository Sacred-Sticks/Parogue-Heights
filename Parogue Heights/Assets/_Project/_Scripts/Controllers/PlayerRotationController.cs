    ...
    public class PlayerRotationController : Observable, IInputReceiver
    {
        ...
        [Inject] private CinemachineVirtualCamera VCam
        {
            ...
            set
            {
                ...
                highRig = new RigSettings(2, VCam.LookAt.transform.localPosition + Vector3.up * 0.5f);
                midRig = new RigSettings(3, VCam.LookAt.transform.localPosition);
                lowRig = new RigSettings(1, VCam.LookAt.transform.localPosition - Vector3.up * 1.0f);
            }
        }
